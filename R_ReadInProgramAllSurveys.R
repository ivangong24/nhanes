...
srvyin <- paste("<SURVEYNAME>_MORT_2015_PUBLIC.dat")   # full .DAT name here
srvyout <- "<SURVEY>" # shorthand dataset name here
...
srvyin <- paste("<SURVEY>_MORT_2015_PUBLIC.dat")   # full .DAT name here
srvyout <- "<SURVEY>" # shorthand dataset name here
